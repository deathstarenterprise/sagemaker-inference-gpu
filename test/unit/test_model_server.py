...
@patch("sagemaker_inference_gpu.model_server._retry_retrieve_mms_server_process")
@patch("sagemaker_inference_gpu.model_server._add_sigterm_handler")
@patch("sagemaker_inference_gpu.model_server._install_requirements")
@patch("os.path.exists", return_value=True)
@patch("sagemaker_inference_gpu.model_server._create_model_server_config_file")
@patch("sagemaker_inference_gpu.model_server._adapt_to_mms_format")
@patch("sagemaker_inference_gpu.environment.Environment")
...
@patch("sagemaker_inference_gpu.model_server._set_python_path")
...
@patch("sagemaker_inference_gpu.model_server._generate_mms_config_properties")
@patch("sagemaker_inference_gpu.utils.write_file")
@patch("sagemaker_inference_gpu.environment.Environment")
...
@patch("sagemaker_inference_gpu.utils.read_file", return_value=DEFAULT_CONFIGURATION)
@patch("sagemaker_inference_gpu.environment.Environment")
...
@patch("sagemaker_inference_gpu.model_server.retry", return_value=lambda f: f)
@patch("sagemaker_inference_gpu.model_server._retrieve_mms_server_process", return_value=17)

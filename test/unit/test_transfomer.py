...
@patch("sagemaker_inference_gpu.transformer.Transformer._run_handler_function", return_value=RESULT)
@patch("sagemaker_inference_gpu.utils.retrieve_content_type_header", return_value=CONTENT_TYPE)
@patch("sagemaker_inference_gpu.transformer.Transformer.validate_and_initialize")
...
@patch("sagemaker_inference_gpu.transformer.Transformer._run_handler_function")
@patch("sagemaker_inference_gpu.utils.retrieve_content_type_header", return_value=CONTENT_TYPE)
@patch("sagemaker_inference_gpu.transformer.Transformer.validate_and_initialize")
...
@patch("sagemaker_inference_gpu.transformer.Transformer._run_handler_function")
@patch("sagemaker_inference_gpu.utils.retrieve_content_type_header")
@patch("sagemaker_inference_gpu.transformer.Transformer.validate_and_initialize")
...
@patch(
    "sagemaker_inference_gpu.transformer.Transformer._run_handler_function",
...
@patch("sagemaker_inference_gpu.transformer.Transformer._validate_user_module_and_set_functions")
...
@patch("sagemaker_inference_gpu.transformer.find_spec", return_value=None)
...
@patch("sagemaker_inference_gpu.transformer.find_spec", return_value=Mock())
